const questions11 = [
    // {
    //     question: "Quel est le pere de l'anatmie pathologique?",
    //     answers:  [
    //         {text: "Antonio Malpighi", correct: true},
    //         {text: "Antoine Paré", correct: false},
...
document.addEventListener('DOMContentLoaded', () => {
    const quiz11 = new QuizGame('quiz-container-11', questions11);
});
